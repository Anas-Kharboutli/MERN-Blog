...
import { OAuth } from "../pages/exports";
...
const SignIn = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if ( !formData.email || !formData.password ) {
      return dispatch(signInFailure("Please fill ot all fields"));
    }
    try {
  ...
  return (
    <div className="min-h-screen mt-20">
      ...
      This is only a demo project, Sign in with your email and password</p>
        </div>
